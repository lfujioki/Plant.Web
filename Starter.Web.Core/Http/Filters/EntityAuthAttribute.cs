...
namespace Starter.Web.Core.Http.Filters
{
    public class EntityAuthAttribute : BaseAuthActionFilterAttribute
    {
        ...
        /// <summary>
        /// Uses the EntityIdField to pull out the Identity Field Value of the Model 
        /// to be modified from the Model or ActionArguments
        /// </summary>
