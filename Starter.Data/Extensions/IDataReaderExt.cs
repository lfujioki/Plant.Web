...
namespace Starter.Data
{
    public static class IDataReaderExt
    {
        ...
        */
        ...
        {
            SqlDataReader sr =  reader as SqlDataReader;

            if (sr != null && reader[ordinal] != null && reader[ordinal] != DBNull.Value)
            {
                return sr.GetTimeSpan(ordinal);
            }
            else if(sr == null)
            {
